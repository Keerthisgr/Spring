...
import com.xworkz.countryapp.entity.WashingMachineEntity;
import com.xworkz.countryapp.repository.WashingMachineRepositoryImpl;
...
public class WashingMachineServiceImpl implements WashingMachineService{
    @Autowired
    WashingMachineRepositoryImpl repository;
    @Override
    public Boolean validateAndSave(WashingMachineDto dto) {
        ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory();
        Validator validator = validatorFactory.getValidator();
        Set<ConstraintViolation<WashingMachineDto>> validate = validator.validate(dto);
